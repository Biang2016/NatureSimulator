...
//%CodeKey:ys5qtPz6bE2j+CdGd8QkOg
/*
    ...
    private int _liveHandle;
            ...
            do {
                switch (node) {
                    case 0:
                        ...
                        #if UNITY_EDITOR
                            if (_live != null) _live = _live.SetLiveValue(10, _liveHandle, NodeVal.Running, false, true);
                        #endif
                        n0c = 1;
                        node = 1;
                    ...
                    case 15:
                        ...
                        #if UNITY_EDITOR
                            if (_live != null) _live = _live.SetLiveValue(10, _liveHandle, ret, true, false);
                        #endif
                            yield return null;
                        }
                        break;
        ...
        public bool SetLive(LiveUpdate live, string treeKey, string codeKey, int liveHandle, out bool codeMatch) {
            if (treeKey == "P+D8lcFaO0uyxGpa3x2lyA") {
                _live = live;
                codeMatch = (codeKey == "ys5qtPz6bE2j+CdGd8QkOg");
                if (codeMatch) {
